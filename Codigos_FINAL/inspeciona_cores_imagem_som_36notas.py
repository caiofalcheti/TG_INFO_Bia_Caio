...
WINDOW_NAME = "Leitor de cores - imagem (ESC para sair)"
...
# -------------------------------
# TABELA DE CORES CSS3 em inglês
# -------------------------------
CSS3_COLORS = {
...
NOTAS = [
    # Oitava 3
    (130, "C3"), (138, "C#3"), (146, "D3"), (155, "D#3"),
    (164, "E3"), (174, "F3"), (185, "F#3"), (196, "G3"),
    (207, "G#3"), (220, "A3"), (233, "A#3"), (246, "B3"),
...
def on_mouse(event, x, y, flags, userdata):
    global mouse_x, mouse_y, mouse_inside, current_frame, last_click_time
...
def main():
    ...
    while True:
        ...
        #Se pressionar tecla ESC, encerra o código
